...
const skills: Skill[] = [
  {
    ...
    tag: "Core",
    tagZh: "核心",
    desc: "The foundational skill that converts QQ_GenUI design system specs into production mobile pages. Enforces strict Gate-based workflow with auto spec retrieval, icon localization, and up to 3 rounds of regression testing.",
    descZh: "核心基础 skill，将 QQ_GenUI 设计系统规范转化为生产级移动端页面。强制执行 Gate 流程，自动检索组件规范、图标本地化、最多 3 轮回归测试。",
    highlights: [
      "11-stage Gate workflow (Gate -1 → Gate 10)",
      "Auto component spec retrieval via Knot MCP",
      "Icon localization to local assets",
      "Failure log & regression testing",
    ],
    highlightsZh: [
      "11 阶段 Gate 流程（Gate -1 → Gate 10）",
      "通过 Knot MCP 自动检索组件规范",
      "图标资源本地化下载",
      "失败日志 + 严格回归测试",
    ],
    repo: "https://github.com/qkj91927/QQ_GenUI/tree/main/skills/QQ-GENUI-basic1.0",
    installCmd: "npx skills add qkj91927/QQ_GenUI/QQ-GENUI-basic1.0",
    official: true,
  },
  {
    id: "switch-style",
    ...
    tag: "Style",
    tagZh: "风格",
    desc: "Transform any existing UI into a target brand's visual style while preserving structure and content. Supports 58 brand design systems including Apple, Stripe, Tesla, Figma, and more.",
    descZh: "在保持页面结构和内容不变的前提下，将任意 UI 界面切换为目标品牌的视觉风格。支持 58 个品牌设计系统，包括 Apple、Stripe、Tesla、Figma 等。",
    highlights: [
      "58 brand design systems supported",
      "Color, typography, components, layout, depth",
      "Auto light/dark mode handling",
      "Strict DESIGN.md compliance",
    ],
    highlightsZh: [
      "支持 58 个品牌设计系统",
      "颜色、排版、组件、布局、深度全覆盖",
