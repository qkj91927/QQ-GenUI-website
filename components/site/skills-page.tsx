...
const skills: Skill[] = [
  {
    ...
    tag: "Core",
    tagZh: "核心",
    desc: "The foundational skill that converts QQ_GenUI design system specs into production mobile pages. Enforces a strict 11-stage Gate workflow with Knot MCP auto spec retrieval, icon localization, background color constraints, and up to 3 rounds of regression testing across 5 audit dimensions.",
    descZh: "核心基础 skill，将 QQ_GenUI 设计系统规范转化为生产级移动端页面。强制执行 11 阶段 Gate 流程，通过 Knot MCP 按需检索组件规范，图标本地化，背景色强约束，最多 3 轮 5 维度回归测试。",
    highlights: [
